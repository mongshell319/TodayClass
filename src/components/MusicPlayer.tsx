...
export function MusicPlayer() {
  ...
  const musicTracks: MusicTrack[] = [
    ...
    },
    {
      ...
      title: '자연의 소리 - 집중력 향상',
      artist: '네이처 사운드',
      youtubeId: '5qap5aO4i9A', // Nature Sounds
      category: 'focus'
    },
    {
      id: '3',
      title: '따뜻한 카페 음악',
      artist: '릴렉스 뮤직',
      youtubeId: 'rUxyKA_-grg', // Cafe Music
      category: 'healing'
    },
    {
      id: '4',
      title: '클래식 - 마음의 평화',
      artist: '클래식 컬렉션',
      youtubeId: 'B7KHKksJtPU', // Classical Music
      category: 'healing'
    },
    {
      id: '5',
      title: '활력 넘치는 모닝 뮤직',
      artist: '에너지 뮤직',
      youtubeId: '36YnV9STBqc', // Morning Music
      category: 'energy'
    }
  ];
        ...
        <CardContent className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${getCategoryColor(currentTrack.category)} flex items-center justify-center`}>
          ...
          <div className="text-center mb-6">
            ...
            <div className="mt-2">
              <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs bg-gradient-to-r ${getCategoryColor(currentTrack.category)} text-white/80 border border-white/10`}>
                ...
                {currentTrack.category === 'focus' ? '집중' : 
                 currentTrack.category === 'healing' ? '힐링' : '활력'}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-6">
            ...
            <Button
              onClick={() => {
                setCurrentTrackIndex(Math.floor(Math.random() * musicTracks.length));
                setIsPlaying(false);
              }}
              variant="ghost"
              size="sm"
