...
export function LandingPage({ onNavigateToTeacherDashboard, onNavigateToSchoolQuest, onNavigateToSchoolLife, onNavigateToStudentRecord }: LandingPageProps) {
  ...
  useEffect(() => {
    ...
    const animationDuration = 3000; // 3초 동안 애니메이션 (30회)
    const intervalTime = 100; // 100ms마다 폰트 변경
  ...
  // Mock weather data - 실제 구현 시 날씨 API로 대체 가능
  const getWeatherInfo = () => {
    ...
    // 시간대에 따라 다른 날씨를 보여주도록 (실제로는 API에서 가져올 데이터)
    const currentHour = new Date().getHours();
    const index = Math.floor(currentHour / 6) % mockWeatherData.length;
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="mb-12">
            ...
            <div className="mb-4" style={{ fontFamily: "'Noto Serif KR', serif" }}>
              {/* 당신의 수업 제목 */}
              <h1 className="text-[70px] bg-gradient-to-r from-slate-400 via-purple-400 to-pink-400 bg-clip-text text-transparent font-medium text-center leading-tight" style={{ fontFamily: "'Noto Serif KR', serif" }}>
                오늘의 수업
              </h1>
            </div>
            ...
            <div className="max-w-2xl mx-auto mt-8 mb-8">
              <div className="relative">
                ...
                {/* 전송 피드백 메시지 */}
                {showSentMessage && (
                  <div className="mt-4 p-3 bg-green-500/20 backdrop-blur-md border border-green-400/30 rounded-xl animate-in slide-in-from-bottom-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 max-w-6xl mx-auto">
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/15 transition-all duration-500 group cursor-pointer overflow-hidden">
              <CardContent className="p-8 text-center relative">
                ...
                <div className="relative z-10">
                  <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-blue-400/20 to-purple-400/20 backdrop-blur-sm rounded-3xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/15 transition-all duration-500 group cursor-pointer overflow-hidden">
              <CardContent className="p-8 text-center relative">
                ...
                <div className="relative z-10">
                  <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-purple-400/20 to-pink-400/20 backdrop-blur-sm rounded-3xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/15 transition-all duration-500 group cursor-pointer overflow-hidden">
              <CardContent className="p-8 text-center relative">
                ...
                <div className="relative z-10">
                  <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-emerald-400/20 to-blue-400/20 backdrop-blur-sm rounded-3xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/15 transition-all duration-500 group cursor-pointer overflow-hidden">
              <CardContent className="p-8 text-center relative">
                ...
                <div className="relative z-10">
                  <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-indigo-400/20 to-violet-400/20 backdrop-blur-sm rounded-3xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/70 text-sm leading-relaxed" style={{ fontFamily: "'Noto Sans KR', sans-serif" }}>
                  <strong>School Quest</strong>를 제외한 모든 서비스(선생님 워크스페이스, 학교 생활, 생활기록부)의 데이터는 
                  현재 사용하고 계신 컴퓨터(브라우저)에만 저장됩니다. 
          ...
          {/* Time display */}
          <div className="mt-8 text-white/60" style={{ fontFamily: "'Noto Sans KR', sans-serif" }}>
